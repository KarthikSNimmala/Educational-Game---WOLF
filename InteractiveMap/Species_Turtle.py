...
def information(): 
    ...
    title = title_font.render('Turtles' , True , color)
    ...
    WolfPark_heading = heading_font.render('Turtles and Wolf Park', True, color)
    protect_heading = heading_font.render('How can people protect Turtles?', True, color)
