...
class Rabbit(Animal):
    def __init__(self,xpos,ypos,height,width,appearance):
        self.direction = 0
        super().__init__(xpos,ypos,height,width,appearance,'rabbit',12,20)
...
class Deer(Animal):
    def __init__(self,xpos,ypos,height,width,appearance):
        self.direction = 0
        super().__init__(xpos,ypos,height,width,appearance,'deer',23,30)
...
class Wolf(Animal):
    def __init__(self,xpos,ypos,height,width,appearance,name):
        self.name = name
        super().__init__(xpos,ypos,height,width,appearance,'wolf',20,45)
