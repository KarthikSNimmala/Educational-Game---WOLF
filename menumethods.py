...
def get_menu_graphics(window_width,window_height):
    ...
    indicator_high = pygame.image.load(os.path.join('Assets',"indicator_paw_highlight.png"))
    indicator_high = pygame.transform.scale(indicator_high,(int(window_height/12),int(window_height/12)))
    #indicator2 = pygame.transform.flip(indicator,True,False)
    #indicator3 = pygame.transform.flip(indicator_high,True,False)
    menuGraphics['indicator'] = indicator
    #menuGraphics['indicator2'] = indicator2
    menuGraphics['indicator_high'] = indicator_high
    #menuGraphics['indicator3'] = indicator3
    return menuGraphics
